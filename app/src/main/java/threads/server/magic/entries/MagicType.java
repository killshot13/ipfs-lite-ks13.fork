...
import threads.server.magic.types.BigEndianString16Type;
import threads.server.magic.types.ByteType;
import threads.server.magic.types.DefaultType;
import threads.server.magic.types.DoubleType;
import threads.server.magic.types.FloatType;
import threads.server.magic.types.Id3LengthType;
import threads.server.magic.types.IntegerType;
import threads.server.magic.types.LittleEndianString16Type;
import threads.server.magic.types.LocalDateType;
import threads.server.magic.types.LocalLongDateType;
import threads.server.magic.types.LongType;
import threads.server.magic.types.PStringType;
import threads.server.magic.types.RegexType;
import threads.server.magic.types.SearchType;
import threads.server.magic.types.ShortType;
import threads.server.magic.types.StringType;
import threads.server.magic.types.UtcDateType;
import threads.server.magic.types.UtcLongDateType;
